...
GE_result = {
    "Lab": 34.4, "Con": 25.9, "LD": 13.2, "RUK": 15.3, "Green": 7.3, 
     "All other candidates": 3.4
}
...
results_pct = results[["Valid votes", "Constituency name", "Country name", "Con", "Lab", "LD", "RUK", "Green", "All other candidates"]]
results_pct = results_pct[results_pct['Country name'] == 'England']
