...
party_columns = ["Con", "Lab", "LD", "RUK", "Green", "PC", "All other candidates"]
polls = pd.read_csv("welsh_polls.csv")

# Rename poll columns
rename_dict = {
    'Lab': 'Lab', 'Con': 'Con', 'REF': 'RUK', 'LD': 'LD',
    'Greens': 'Green','PC': 'PC', 'Others': 'All other candidates'
}
...
GE_result = {
    "Lab": 37.0, "Con": 18.2, "LD": 6.5, "RUK": 16.9, "Green": 4.7, 
    "PC": 14.8, "All other candidates": 1.5
}
...
results_pct = results[["Valid votes", "Constituency name", "Country name", "Con", "Lab", "LD", "RUK", "Green", "PC", "All other candidates"]]
results_pct = results_pct[results_pct['Country name'] == 'Wales']
