...
party_columns = ["Con", "Lab", "LD", "RUK", "Green", "SNP", "All other candidates"]
polls = pd.read_csv("scottish_polls.csv")
...
GE_result = {
    "Lab": 35.3, "Con": 12.7, "LD": 9.7, "RUK": 7.0, "Green": 3.8, 
    "SNP": 30.0, "All other candidates": 1.2
}
...
results_pct = results[["Valid votes", "Constituency name", "Country name", "Con", "Lab", "LD", "RUK", "Green", "SNP", "All other candidates"]]
results_pct = results_pct[results_pct['Country name'] == 'Scotland']
